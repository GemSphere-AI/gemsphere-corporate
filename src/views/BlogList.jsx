            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {BLOG_POSTS.map((post) => (
                    <article key={post.id} className="flex">
                        <LocalizedLink 
                            href={`/blog/${post.id}`}
                            className="glass-card flex flex-col group hover:-translate-y-2 transition-all overflow-hidden w-full"
                        >
                            <div className="p-8 flex-grow">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <time 
                                        ...
                                        className="flex items-center gap-1 text-[10px] text-white/40 font-bold uppercase tracking-wider"
                                    >
