                            ...
                            <ScrollReveal direction="right">
                                <div className="mb-16">
                                    ...
                                    <p className="text-xl text-text-secondary leading-relaxed max-w-lg">
                                        Whether you're looking for a custom enterprise architecture, a demo of our AI platform, or global technical support Ã¢â‚¬â€ we're here to help.
                                    </p>
                                </div>
                            </ScrollReveal>
                                ...
                                <div className="mt-16 p-8 glass-card rounded-[32px] border-brand-indigo/20 relative overflow-hidden">
                                    ...
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-brand-indigo font-semibold">Bangalore, India</p>
                                        </div>
                                    </div>
