...
const PrivacyPolicy = () => {
    return (
        <div className="min-h-screen">
            <Helmet>
                <title>Privacy Policy | GemSphere Technologies</title>
                <meta name="description" content="Read our Privacy Policy to understand how GemSphere Technologies collects, uses, and protects your data." />
            </Helmet>
