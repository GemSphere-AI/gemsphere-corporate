...
const BlogList = () => {
    return (
        <div className="container mx-auto px-6 py-12">
            <Helmet>
                <title>GemSphere Blog | Insights on AI, SaaS & Engineering</title>
                <meta name="description" content="Explore the latest insights on how AI and enterprise software are transforming the global business landscape." />
            </Helmet>
