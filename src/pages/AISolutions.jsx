...
const AISolutions = () => {
    const aiCategory = PRODUCT_ECOSYSTEM.categories.find(c => c.id === 'ai');

    return (
        <div className="min-h-screen">
            <Helmet>
                <title>Enterprise AI Solutions | GemSphere Technologies</title>
                <meta name="description" content="Deploy autonomous AI agents, predictive analytics, and conversational intelligence across your enterprise operations." />
            </Helmet>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <ul className="space-y-4 mb-8">
                                    {['SOC2 Type II Certified', 'HIPAA Compliant Infrastructure', 'Zero-Data-Retention Policies', 'Role-Based Inference Access'].map((item, i) => (
