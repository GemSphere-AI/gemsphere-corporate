...
const Careers = () => {
    return (
        <div className="min-h-screen">
            <Helmet>
                <title>Careers at GemSphere | Engineering the Future</title>
                <meta name="description" content="Join our elite team of engineers, architects, and AI researchers building the next generation of enterprise software." />
            </Helmet>
            ...
            <section id="open-roles" className="py-24 relative">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="space-y-4">
                        {[
                            { role: 'Senior AI Researcher', team: 'AI Platform', loc: 'Remote / Dubai', type: 'Full-time' },
