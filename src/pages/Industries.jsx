...
const Industries = () => {
    return (
        <div className="min-h-screen">
            <Helmet>
                <title>Industries We Serve | GemSphere Technologies</title>
                <meta name="description" content="Discover how GemSphere's unified platform drives digital transformation across Retail, Healthcare, FinTech, Logistics, and Manufacturing." />
            </Helmet>
