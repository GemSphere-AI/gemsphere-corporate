...
const Products = () => {
    ...
    return (
        <div className="min-h-screen">
            <Helmet>
                <title>Enterprise Products Ecosystem | GemSphere Technologies</title>
                <meta name="description" content="Explore our unified platform with 28+ modular components across Commerce, Supply Chain, Finance, Operations, AI, and Collaboration." />
            </Helmet>
                    ...
                    <ScrollReveal direction="up">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-xl text-text-secondary mb-10 leading-relaxed max-w-3xl mx-auto">
                                28+ enterprise modules built on a shared data model. Adopt what you need today, seamlessly scale to full capabilities tomorrow.
                            </p>
