...
const CookiePolicy = () => {
    return (
        <div className="min-h-screen">
            <Helmet>
                <title>Cookie Policy | GemSphere Technologies</title>
                <meta name="description" content="Learn about how GemSphere Technologies uses cookies and similar technologies on our website." />
            </Helmet>
