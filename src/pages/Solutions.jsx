...
const Solutions = () => {
    return (
        <div className="min-h-screen">
            <Helmet>
                <title>Industry Solutions | GemSphere Technologies</title>
                <meta name="description" content="Pre-configured enterprise ecosystems tailored for Retail, Healthcare, FinTech, Logistics, and Manufacturing." />
            </Helmet>
