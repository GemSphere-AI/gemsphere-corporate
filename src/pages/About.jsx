    ...
    return (
        <div className="min-h-screen">
            <Helmet>
                ...
                <meta name="description" content="Learn about the engineering DNA, mission, and team behind GemSphere Technologies — a global leader in enterprise AI and software." />
            </Helmet>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <ScrollReveal direction="left">
                            <div className="glass-card p-10 rounded-[32px] border-brand-cyan/20 relative overflow-hidden h-full">
                                ...
                                <h3 className="text-3xl font-bold text-text-primary mb-2">Dubai (HQ)</h3>
                                <p className="text-brand-cyan font-semibold mb-6">EMEA & Global Strategy</p>
                        ...
                        <ScrollReveal direction="right">
                            <div className="glass-card p-10 rounded-[32px] border-brand-indigo/20 relative overflow-hidden h-full">
                                ...
                                <h3 className="text-3xl font-bold text-text-primary mb-2">Bangalore</h3>
                                <p className="text-brand-indigo font-semibold mb-6">Global Engineering Center</p>
                                <p className="text-text-secondary">
                                    HSR Layout<br />
                                    Bangalore, India
                                </p>
